	...
	if (empty($_POST['mod_id'])) {
		...
		//Aqui termina el codigo ingresado Por Carlos Bejarano
			...
			if ($query_insert){
				...
				$sql2 = "update ticket set status_id=\"$status_id\", asigned_id=\"$asigned_id\", updated_at=NOW() where id=$id";
...
?>
	...
	<div> <!-- Modal -->
        ...
        <a href= "../Tickets_Asignados.php" class="btn btn-primary" onClick= "tickets.php" >Atras</a>
    </div>
